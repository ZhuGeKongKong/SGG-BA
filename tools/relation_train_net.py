        ...
        if clean_classifier:
            ...
            if cfg.MODEL.ROI_RELATION_HEAD.PREDICTOR == "TransformerTransferPredictor":
                ...
                if cfg.MODEL.ROI_RELATION_HEAD.PREDICT_USE_BIAS:
                    load_mapping_classifier["roi_heads.relation.predictor.freq_bias_clean"] = "roi_heads.relation.predictor.freq_bias"
            ...
            if cfg.MODEL.ROI_RELATION_HEAD.PREDICTOR == "CausalAnalysisPredictor":
                load_mapping_classifier = {
                    "roi_heads.relation.predictor.ctx_compress_clean": "roi_heads.relation.predictor.ctx_compress",
                    "roi_heads.relation.predictor.vis_compress_clean": "roi_heads.relation.predictor.vis_compress",
                }
                if cfg.MODEL.ROI_RELATION_HEAD.PREDICT_USE_BIAS:
                    load_mapping_classifier["roi_heads.relation.predictor.freq_bias_clean"] = "roi_heads.relation.predictor.freq_bias"
            # load_mapping_classifier = {}
