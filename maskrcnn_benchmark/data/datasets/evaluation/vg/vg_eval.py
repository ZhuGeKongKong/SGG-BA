...
def do_vg_evaluation(
    ...
    if dataset.__class__.__name__ == "VGDataset":
    ...
    elif dataset.__class__.__name__ == "GQADataset":
        zeroshot_triplet = np.load("./datasets/gqa/sceneGraphs/zeroshot_triplet.npy")
        zeroshot_triplet = zeroshot_triplet.astype("long")
