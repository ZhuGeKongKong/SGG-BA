...
def get_dataset_statistics(cfg):
    ...
    for dataset_name in dataset_names:
        ...
        args = data["args"]
        args['with_clean_classifier'] = False
...
def make_data_loader(cfg, mode='train', is_distributed=False, start_iter=0):
    ...
    for dataset in datasets:
        ...
        if cfg.TEST.CUSTUM_EVAL:
            ...
            with open(os.path.join(cfg.OUTPUT_DIR, 'custom_data_info.json'), 'w') as outfile:
                json.dump(custom_data_info, outfile)
            print('=====> ' + str(os.path.join(cfg.OUTPUT_DIR, 'custom_data_info.json')) + ' SAVED !')
