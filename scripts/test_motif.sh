...
if [ $1 == "0" ]; then
    ...
    MODEL_NAME="motif_predcls_TopDist15_TopBLMaxDist2k_FixPModel_lr1e3_B16"
    python  -u  -m torch.distributed.launch --master_port 10035 --nproc_per_node=$NUM_GUP \
            ...
            MODEL.WEIGHT ./checkpoints/${MODEL_NAME}/model_0020000.pth \
    ...
    export NUM_GUP=2
    echo "Testing SGCls"
    MODEL_NAME="motif_sgcls_TopDist15_TopBLMaxDist2k_FixPModel_lr1e3_B16"
    ...
    export NUM_GUP=1
    echo "Testing SGDet"
    MODEL_NAME="motif_sgdet_TopDist15_TopBLMaxDist2k_FixBiGraph_lr1e3_B16"
