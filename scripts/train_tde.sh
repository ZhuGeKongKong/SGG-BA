...
if [ $1 == "0" ]; then
    ...
    MODEL_NAME="transformer_predcls_tde_blru_cm_0_01_auloss" #"transformer_predcls_dist15_2k_KD0_8_KLt1_freq_TranN2C_1_0_KLt1_InitPreModel_lr1e4"
    ...
    MODEL.PRETRAINED_MODEL_CKPT ./checkpoints/transformer_predcls_tde/model_final.pth \
